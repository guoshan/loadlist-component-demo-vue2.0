<template>
    <div class="page">
        <div class="page-content">
            <common-list ref="order_list" class="order_list">
                <div slot="list-top">
                    <div class="_weui-btn-group">
                        <div @click="btn_item_click($event,2)" class="item selected">tab1</div>
                        <div @click="btn_item_click($event,10)" class="item">tab2</div>
                    </div>
                </div>
